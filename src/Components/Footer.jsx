...
function Footer() {
  return (
    <div> <div className='d-flex justify-content-center align-items-center flex-column text-light mt-5 p-4 py-5' style={{width:"100%",backgroundColor:'#9f71f5'}}>
    <div className='footer-content d-flex justify-content-evenly w-100 flex-wrap'>
      <div style={{width:'400px'}} className='website'>
        <h4><i style={{height:'25px'}} className="fa-solid fa-laptop-code fa-bounce me-2 "></i><b>Project Fair</b></h4>
